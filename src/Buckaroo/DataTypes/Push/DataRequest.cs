...
namespace Buckaroo
{
  ...
  public class DataRequest : Push
  {
    ...
    /// </summary>
    public new List<ServiceResponse> Services { get; set; }
    /// <summary>
    ...
    public new List<ServiceEnum> GetServices()
    {
    ...
    public new T GetActionResponse<T>() where T : ActionResponse, new()
    {
      var result = new T();

      var service = Services.FirstOrDefault(s => s.Name.Equals(result.ServiceEnum.ToString(), StringComparison.OrdinalIgnoreCase));
